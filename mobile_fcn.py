...
st.caption("Autocallable FCN with Daily KO Logic (Clean Edition)")
...
ko_prob, win_rate = (ko_count/n_paths)*100, ((n_paths-ki_count)/n_paths)*100
...
st.markdown(f"""
    <div style="background-color: #1E1E1E; padding: 15px; border-radius: 12px; border: 2px solid #00FFA3; text-align: center;">
        <div style="display: flex; justify-content: space-around;">
            <div><p style="color: #00FFA3; margin:0;">🚀 KO Prob.</p><p style="color: #FFF; font-size: 24px; font-weight: bold;">{ko_prob:.1f}%</p></div>
            <div><p style="color: #FF4B4B; margin:0;">🛡️ Win Rate</p><p style="color: #FFF; font-size: 24px; font-weight: bold;">{win_rate:.1f}%</p></div>
        </div>
    </div>
    """, unsafe_allow_html=True)
